...
/**
 * Example: Crawl Masters Portal using Playwright (browser automation)
 * This approach bypasses anti-bot protection like Cloudflare
 */
async function crawlMastersWithPlaywright() {
    console.log('Crawling Masters Portal with Playwright...\n');
    ...
    try {
        ...
        if (results.extractedData.length === 0) {
            ...
            console.log('\n✓ Results saved to masters-programs.json');
        }
...
crawlMastersWithPlaywright().catch(console.error);
